...
def parse_eve_ts(s):
    ...
    # Handle timezone offset format without colon (e.g., "+0000" -> "+00:00")
    # Suricata uses "+0000" but fromisoformat() requires "+00:00"
...
def setup_column_mapping(fields):
    ...
    column_map = {
        ...
        "tls": {
            ...
            "tls_ja3": ["tls", "ja3", "hash"],
            "tls_ja3s": ["tls", "ja3s", "hash"],
        ...
        "fileinfo": {
            ...
            "file_sha1": ["fileinfo", "sha1"],
            "file_sha256": ["fileinfo", "sha256"],
            "file_magic": ["fileinfo", "magic"],
            "file_state": ["fileinfo", "state"],
            "file_stored": ["fileinfo", "stored"],
        },
    }
    ...
    for col, typ in zip(columns, types):
        ...
        if col == "file_stored":
            column_actions[col] = lambda val: str(val).lower() if val is not None else None
            logger.debug(f"  Action for {col}: boolean to string conversion")
